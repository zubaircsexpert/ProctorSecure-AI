import{t as e}from"./mic-C69kUYfE.js";import{t}from"./send-BnsngS-2.js";import{t as n}from"./square-DsyKIOTz.js";import{t as r}from"./trash-2-BDrUE3Ms.js";import{d as i,g as a,i as o,l as ee,n as s,r as c,t as l}from"./index-B3XdOcIb.js";var u=i(`check-check`,[[`path`,{d:`M18 6 7 17l-5-5`,key:`116fxf`}],[`path`,{d:`m22 10-7.5 7.5L13 16`,key:`ke71qq`}]]),d=i(`image`,[[`rect`,{width:`18`,height:`18`,x:`3`,y:`3`,rx:`2`,ry:`2`,key:`1m3agn`}],[`circle`,{cx:`9`,cy:`9`,r:`2`,key:`af1f0g`}],[`path`,{d:`m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21`,key:`1xmnt7`}]]),f=i(`lock`,[[`rect`,{width:`18`,height:`11`,x:`3`,y:`11`,rx:`2`,ry:`2`,key:`1w4ew1`}],[`path`,{d:`M7 11V7a5 5 0 0 1 10 0v4`,key:`fwvmzm`}]]),p=i(`paperclip`,[[`path`,{d:`m16 6-8.414 8.586a2 2 0 0 0 2.829 2.829l8.414-8.586a4 4 0 1 0-5.657-5.657l-8.379 8.551a6 6 0 1 0 8.485 8.485l8.379-8.551`,key:`1miecu`}]]),m=i(`phone`,[[`path`,{d:`M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384`,key:`9njp5v`}]]),h=i(`video`,[[`path`,{d:`m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5`,key:`ftymec`}],[`rect`,{x:`2`,y:`6`,width:`14`,height:`12`,rx:`2`,key:`158x01`}]]),g=a(),_=l(),v=e=>{if(!e)return``;if(/^https?:\/\//i.test(e))return e;let t=String(e).replace(/^\/+/,``);return`${s.defaults.baseURL}/${t}`},y=e=>{if(!e)return`Last seen not available`;let t=new Date(e),n=Date.now()-t.getTime(),r=Math.max(1,Math.round(n/6e4));return r<2?`Last seen just now`:r<60?`Last seen ${r} min ago`:`Last seen ${t.toLocaleString([],{dateStyle:`medium`,timeStyle:`short`})}`},b=()=>{let i=o(),[a,l]=(0,g.useState)([]),[b,x]=(0,g.useState)(``),[S,C]=(0,g.useState)(``),[w,T]=(0,g.useState)(``),[E,D]=(0,g.useState)([]),[O,k]=(0,g.useState)(``),[A,j]=(0,g.useState)(null),[M,N]=(0,g.useState)(``),[P,F]=(0,g.useState)(!0),[I,L]=(0,g.useState)(!1),[R,z]=(0,g.useState)(!1),B=(0,g.useRef)(null),V=(0,g.useRef)(null),H=(0,g.useRef)(null),U=(0,g.useRef)([]),W=a.find(e=>String(e.id)===String(b)),G=b&&String(S)===String(b),K=async({silent:e=!1}={})=>{try{let t=await s.get(`/api/chat/contacts`),n=Array.isArray(t.data)?t.data:[];l(n),x(e=>e||String(n[0]?.id||``)),e||N(``)}catch(t){console.error(`Chat contacts failed`,t),e||N(t.response?.data?.message||`Contacts could not be loaded.`)}finally{F(!1)}},q=async({silent:e=!1}={})=>{if(!b||!G){D([]),F(!1);return}try{let t=await s.get(`/api/chat/messages`,{params:{recipientId:b,chatCode:w}});D(Array.isArray(t.data)?t.data:[]),e||N(``)}catch(t){console.error(`Chat fetch failed`,t),e||N(t.response?.data?.message||`Chat could not be loaded.`),t.response?.status===403&&C(``)}finally{F(!1)}};(0,g.useEffect)(()=>{let e=()=>{s.post(`/api/chat/heartbeat`).catch(()=>{})},t=()=>{s.post(`/api/chat/offline`).catch(()=>{})},n=()=>{let e=c(),t=`${s.defaults.baseURL}/api/chat/offline`;fetch(t,{method:`POST`,headers:e?{Authorization:`Bearer ${e}`}:{},keepalive:!0}).catch(()=>{})},r=()=>{document.visibilityState===`hidden`?n():(e(),K({silent:!0}))};K(),e();let i=window.setInterval(()=>{e(),K({silent:!0})},3e4);return document.addEventListener(`visibilitychange`,r),window.addEventListener(`pagehide`,n),window.addEventListener(`beforeunload`,n),()=>{window.clearInterval(i),document.removeEventListener(`visibilitychange`,r),window.removeEventListener(`pagehide`,n),window.removeEventListener(`beforeunload`,n),t()}},[]),(0,g.useEffect)(()=>{C(``),T(``),D([])},[b]),(0,g.useEffect)(()=>{q();let e=window.setInterval(()=>q({silent:!0}),5e3);return()=>window.clearInterval(e)},[b,G,w]),(0,g.useEffect)(()=>{B.current?.scrollIntoView({behavior:`smooth`})},[E.length]);let J=async()=>{if(!b){N(`Select a student or teacher first.`);return}if(w.trim().length<4){N(`Enter the private code. Both users must type the same code.`);return}try{F(!0),await s.post(`/api/chat/session`,{recipientId:b,chatCode:w.trim()}),C(b),N(``)}catch(e){console.error(`Chat unlock failed`,e),N(e.response?.data?.message||`Chat code could not be verified.`)}finally{F(!1)}},Y=async(e=null)=>{let t=e||A;if(!O.trim()&&!t){N(`Type a message or attach a picture/video/voice note.`);return}if(!G){N(`Unlock this chat with the private code first.`);return}try{L(!0);let e=new FormData;e.append(`text`,O.trim()),e.append(`recipientId`,b),e.append(`chatCode`,w.trim()),t&&e.append(`file`,t),await s.post(`/api/chat/messages`,e),k(``),j(null),V.current&&(V.current.value=``),await q({silent:!0})}catch(e){console.error(`Chat send failed`,e),N(e.response?.data?.message||`Message could not be sent.`)}finally{L(!1)}},X=async()=>{if(!G){N(`Unlock this chat with the private code before clearing it.`);return}if(window.confirm(`Clear this secure chat for both users? A new code will be required next time.`))try{await s.delete(`/api/chat/messages`,{params:{recipientId:b,chatCode:w}}),D([]),C(``),T(``),N(`Chat cleared for both users. Set a new code to chat again.`)}catch(e){console.error(`Chat clear failed`,e),N(e.response?.data?.message||`Chat could not be cleared.`)}},Z=async()=>{if(!G){N(`Unlock this chat with the private code before recording a voice note.`);return}if(!navigator.mediaDevices?.getUserMedia||!window.MediaRecorder){N(`Voice recording is not supported in this browser.`);return}try{let e=await navigator.mediaDevices.getUserMedia({audio:!0}),t=new MediaRecorder(e);U.current=[],t.ondataavailable=e=>{e.data.size&&U.current.push(e.data)},t.onstop=async()=>{e.getTracks().forEach(e=>e.stop());let t=new Blob(U.current,{type:`audio/webm`}),n=new File([t],`voice-note-${Date.now()}.webm`,{type:`audio/webm`});z(!1),await Y(n)},H.current=t,t.start(),z(!0)}catch(e){console.error(`Voice recording failed`,e),N(`Microphone permission is required for voice notes.`)}},Q=()=>{H.current?.stop()},te=e=>{e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),Y())},$=e=>{N(`${e} call option is ready for this contact. Connect a real calling service/WebRTC to start live calls.`)};return(0,_.jsxs)(`div`,{className:`portal-chat`,children:[(0,_.jsx)(`style`,{children:`
        .portal-chat {
